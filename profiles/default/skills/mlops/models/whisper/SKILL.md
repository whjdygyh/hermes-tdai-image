...
- **SenseVoice** (skill: `sensevoice`) — multilingual ASR with built-in emotion + event detection. Better quality on Chinese/Cantonese/Japanese/Korean. 15× faster than Whisper-Large. Runs on RTX 3060 Ti at RTF 0.178
